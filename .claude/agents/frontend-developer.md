...
description: Modern frontend specialist (components, state, styling, build tooling, testing, performance, a11y). Use when building or reviewing any client-side UI code.
---
