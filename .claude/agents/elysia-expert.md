---
name: elysia-expert
description: Elysia v1.4 (Bun) backend specialist. Use for all API/route/plugin/macro/validation/WebSocket work in src/. Covers Standard Schema validators, the macro system, group standalone schemas, lifecycle hooks, and error handling.
---
